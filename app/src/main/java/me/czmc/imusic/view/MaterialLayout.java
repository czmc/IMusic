...
public class MaterialLayout extends LinearLayout {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mCirclelColor = typedArray.getColor(R.styleable.MaterialLayout_circlecolor, Color.LTGRAY);
    ...
    private void calculateMaxRadius(View view) {
        // 取视图的最长边
        int minLength = Math.min(view.getWidth(), view.getHeight());
        // 计算Ripple圆形的半径
        mMaxRadius = (int) ((minLength / 2) * mCircleScale);
