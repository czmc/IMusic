 ...
 */
public class MusicAdapter extends CommonAdapter<MusicData> implements IOnMusicInfoListener {
    private ArrayList<MusicData> mDataList;
    private MusicData music;

    public MusicAdapter(Context mContext, ArrayList<MusicData> mDataList, int mItemResID) {
